<!DOCTYPE html> 
    ...
    <?php        
        ...
        $comment_id = isset($_GET["comment_id"]) ? $_GET["comment_id"] : false;
            ...
            <?php 
                ...
                if ($id_new) {
                    ...
                    if ($result && mysqli_num_rows($result) > 0) {
                        ...
                        echo $total_comments . "<img style = 'width: 2%; height: 2%' src='images/comment-icon.svg'>";
                    } else {
        ...
        <?php if ($username){?> 
        <form class="w-100" action="comments.php" method="post"> 
        ...
        <?php 
            if(mysqli_num_rows($comments_result)) {  
                foreach ($comments as $comment){ 
                    $comment_id = $comment[0]; // Перемещаем эту строку в начало цикла
                    ?> 
